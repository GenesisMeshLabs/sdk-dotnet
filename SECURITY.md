...
- `CanonicalJson` producing incorrect output that could allow signature bypass
...
1. Go to the [Security tab](https://github.com/GenesisMeshLabs/sdk-dotnet/security)
